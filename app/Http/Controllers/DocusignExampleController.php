...
class DocusignExampleController extends BaseController
{
    ...
    {
        self::$apiClient->getOAuth()->setOAuthBasePath(getenv('JWT_AUTHORIZATION_SERVER'));
        $privateKey = file_get_contents('', true);
